   ...
   describe('existingTransaction()', () => {
    ...
    describe('validTransactions()', () => {
       ...
       beforeEach(() => {
           ...
           for (let i = 0; i < 10; i++) {
               transaction = new Transaction({senderWallet, recipient: 'rec1', amount: 100});

               if(i%3===0) {
                   transaction.input.amount = 1000000000;
               } else if(i%3===1) {
                   transaction.input.signature = new Wallet().sign('mischievous data');
               } else {
    ...
    describe('clearBlockchainTransaction()', () => {
        it('clears the pool of any existing blockchain transactions', () => {
            ...
            for (let i = 0; i < 6; i++) {
                const transaction = new Wallet().createTransaction({amount: 100, recipient: 'rec1'});
